...
void loop() {
  // Créer un motif de losange
  matrix.fillScreen(matrix.Color(0, 0, 0));  // Éteindre toutes les LED

  

   matrix.drawPixel(6, 10, matrix.Color(255, 255, 0));
   matrix.drawPixel(6, 9, matrix.Color(255, 255, 0));
   matrix.drawPixel(6, 8, matrix.Color(255, 255, 0));
   matrix.drawPixel(6, 7, matrix.Color(255, 255, 0));
   matrix.drawPixel(6, 6, matrix.Color(255, 255, 0));
   
   matrix.drawPixel(8, 10, matrix.Color(255, 255, 0));
   matrix.drawPixel(8, 9, matrix.Color(255, 255, 0));
   matrix.drawPixel(8, 8, matrix.Color(255, 255, 0));
   matrix.drawPixel(8, 7, matrix.Color(255, 255, 0));
   matrix.drawPixel(8, 6, matrix.Color(255, 255, 0));
  
  matrix.drawPixel(7, 10, matrix.Color(255, 255, 0));
  matrix.drawPixel(7, 8, matrix.Color(255, 255, 0));
  
  matrix.drawPixel(5, 4, matrix.Color(255, 255, 0));
  matrix.drawPixel(5, 1, matrix.Color(255, 255, 0));
  matrix.drawPixel(4, 12, matrix.Color(255, 255, 0));
  matrix.drawPixel(4, 13, matrix.Color(255, 255, 0));
   
  matrix.drawPixel(6, 14, matrix.Color(255, 255, 0));
  matrix.drawPixel(7, 2, matrix.Color(255, 255, 0));
  matrix.drawPixel(8, 14, matrix.Color(255, 255, 0));
  matrix.drawPixel(9, 1, matrix.Color(255, 255, 0));
  matrix.drawPixel(10, 13, matrix.Color(255, 255, 0));
  matrix.drawPixel(10, 12, matrix.Color(255, 255, 0));
  matrix.drawPixel(9, 4, matrix.Color(255, 255, 0));
